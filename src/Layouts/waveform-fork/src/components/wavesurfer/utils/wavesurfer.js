/*!
 * wavesurfer.js 4.4.0 (2021-02-05)
...
var MultiCanvas = /*#__PURE__*/function (_Drawer) {
  ...
  _createClass(MultiCanvas, [{
    ...
    value: function drawBars(peaks, channelIndex, start, end) {
      ...
      return this.prepareDraw(peaks, channelIndex, start, end, function (_ref) {
        ...
        var _loop = function _loop() {
          ...
          var color = void 0,
              timePosition = Math.floor(i * scale * peakIndexScale) / peaks.length;

          _this4.params.colors.forEach(function (e) {
            if (timePosition >= e.start / _this4.params.duration && timePosition < e.end / _this4.params.duration) {
              color = e.color;
            }
          });

          _this4.fillRect(i + _this4.halfPixel, halfH - h + offsetY, bar + _this4.halfPixel, h * 2, _this4.barRadius, ch, color);
        };
     ...
     * @param {string} overrideColor The
     */

  }, {
    key: "fillRect",
    value: function fillRect(x, y, width, height, radius, channelIndex, overrideColor) {
      ...
      for (i; i < endCanvas; i++) {
        ...
        if (intersection.x1 < intersection.x2) {
          ...
          if (overrideColor) this.setFillStyles(entry, overrideColor, overrideColor);else this.setFillStyles(entry, waveColor, progressColor);
